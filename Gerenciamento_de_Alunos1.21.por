	...
	funcao muralAniversario(cadeia listaDeAlunos[][], inteiro mes){
     ...
     funcao logico encerraPrograma(logico fimPrograma){
		 escreva("                                             Encerrando programa! Em 3!\n")
           u.aguarde(1000)
           limpa()
           escreva("\n                                             Encerrando programa! Em 2!\n")
           u.aguarde(1000)
           limpa()
           escreva("\n\n                                             Encerrando programa! Em 1!\n")
           u.aguarde(1000)
           limpa()
			escreva("\n                               AAAAA   TTTTT  EEEEE       L       OOOO   GGGGG   OOOO   \n")
 ...
 * 
 * @POSICAO-CURSOR = 18626; 
 * @DOBRAMENTO-CODIGO = [7, 69, 105, 118, 191, 210, 234, 259, 268, 277, 286, 301, 329, 354, 363, 374, 389, 414, 439, 454, 470, 502, 577, 597];
 * @PONTOS-DE-PARADA = ;
